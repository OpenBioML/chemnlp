...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} represents a molecule that has a {GAFF__names__noun} of {GAFF#} {GAFF__units}: {SMILES#}""",
            ...
            "The {exp_value__names__noun} of the molecule {SMILES__description} {SMILES#} is:<EOI>{exp_value#} {exp_value__units}",
            """Task: Please predict a molecule feature based on the description.
...
Result:<EOI>{SMILES#}""",
            ...
            "The {GAFF__names__noun} of the molecule {SMILES__description} {SMILES#} is:<EOI>{GAFF#} {GAFF__units}",
            """Task: Please predict a molecule feature based on the description.
