...
journal = {Nature Biotechnology}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} represents a molecule that {#shows|exhibits|displays!} {CYP2C19_inhibition#no &NULL}{CYP2C19_inhibition__names__noun}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {CYP2C19_inhibition#not &NULL}{CYP2C19_inhibition__names__gerund}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {CYP2C19_inhibition__names__gerund}:<EOI>{CYP2C19_inhibition#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {CYP2C19_inhibition__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{CYP2C19_inhibition#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {CYP2C19_inhibition__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {CYP2C19_inhibition#not &NULL}{CYP2C19_inhibition__names__gerund}.""",
