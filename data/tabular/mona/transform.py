...
META_TEMPLATE = {
    ...
    "templates": [
        "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} has a {spectral_entropy__names__noun} of {spectral_entropy#} {spectral_entropy__units}.",
        "Based on the {SMILES__description} {#representation of |!}{SMILES#}, the molecule has a {spectral_entropy__names__noun} of {spectral_entropy#} {spectral_entropy__units}.",
        "The {SMILES__description} {SMILES#} {#represents|is representing!} a molecule {#that has a|with a!} {spectral_entropy__names__noun} of {spectral_entropy#} {spectral_entropy__units}.",
        "The molecule with the {SMILES__description} {SMILES#} has a {spectral_entropy__names__noun} of {spectral_entropy#} {spectral_entropy__units}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} represents a molecule that has a {spectral_entropy__names__noun} of {spectral_entropy#} {spectral_entropy__units}: {SMILES#}""",
        ...
        "The {spectral_entropy__names__noun} of the molecule with the {SMILES__description} {SMILES#} is:<EOI>{spectral_entropy#} {spectral_entropy__units}",
        "The {spectral_entropy__names__noun} of the {SMILES__description} {SMILES#} is:<EOI>{spectral_entropy#} {spectral_entropy__units}",
        "The {spectral_entropy__names__noun} of the molecule {SMILES__description} {SMILES#} is:<EOI>{spectral_entropy#} {spectral_entropy__units}",
        """Task: Please predict a molecule feature based on the description.
