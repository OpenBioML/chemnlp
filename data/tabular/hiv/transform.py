...
Assistant: {activity_HIV#No&Yes}, this molecule is {activity_HIV#not &NULL}{activity_HIV__names__adjective}.""",
            """User: Is the molecule with the {SMILES__description} {SMILES#} {activity_HIV__names__adjective}?
Assistant: {activity_HIV#No&Yes}, it is {activity_HIV#not &NULL}{activity_HIV__names__adjective}.""",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {activity_HIV#not &NULL}{activity_HIV__names__adjective}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {activity_HIV__names__adjective}:<EOI>{activity_HIV#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_HIV__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{activity_HIV#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_HIV__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {activity_HIV#not &NULL}{activity_HIV__names__adjective}.""",
