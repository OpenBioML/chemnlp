...
journal = {Frontiers in Environmental Science}""",
        ...
        "templates": [
            ...
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} {#shows|exhibits|displays!} {toxicity_SR-ARE#no &NULL}{toxicity_SR-ARE__names__gerund}.",  # noqa: E501
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {toxicity_SR-ARE#not &NULL}{toxicity_SR-ARE__names__adjective}: {SMILES#}""",  # noqa: E501
            ...
            "Is the {SMILES__description} {SMILES#} {toxicity_SR-ARE__names__adjective}:<EOI> {toxicity_SR-ARE#yes&no}",  # noqa: E501 for the benchmarking setup <EOI> separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-ARE__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
