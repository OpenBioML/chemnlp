...
journal = {Frontiers in Environmental Science}""",
        ...
        "templates": [
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {toxicity_SR-ARE#not &NULL}{toxicity_SR-ARE__names__adjective}.",
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {toxicity_SR-ARE#not &NULL}{toxicity_SR-ARE__names__gerund}.",
            "Based on the {SMILES__description} {#representation |!}{SMILES#}, the molecule has {toxicity_SR-ARE#no &NULL}{toxicity_SR-ARE__names__noun} {#properties|characteristics|features!}.",
            "The {SMILES__description} {SMILES#} {#represents|is from!} a molecule that is {toxicity_SR-ARE#not &NULL}identified as {toxicity_SR-ARE__names__adjective}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {toxicity_SR-ARE#not &NULL}{toxicity_SR-ARE__names__adjective}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {toxicity_SR-ARE__names__adjective}:<EOI>{toxicity_SR-ARE#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-ARE__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{toxicity_SR-ARE#False&True}""",
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_SR-ARE__names__adjective}.
Result:<EOI>{SMILES#}""",
