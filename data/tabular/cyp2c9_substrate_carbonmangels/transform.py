...
journal = {Journal of Chemical Information and Modeling}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} represents a molecule that is {CYP2C9_Substrate#not &NULL}identified as a {CYP2C9_Substrate__names__noun}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {CYP2C9_Substrate#not &NULL}a {CYP2C9_Substrate__names__noun}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} a {CYP2C9_Substrate__names__noun}:<EOI>{CYP2C9_Substrate#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is a {CYP2C9_Substrate__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{CYP2C9_Substrate#False&True}""",
