...
journal = {ASSAY and Drug Development Technologies}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} represents a molecule that is {herg_inhib#not &NULL}a {herg_inhib__names__noun}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {herg_inhib#not &NULL}a {herg_inhib__names__noun}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} a {herg_inhib__names__noun}:<EOI>{herg_inhib#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is a {herg_inhib__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{herg_inhib#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is a {herg_inhib__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {herg_inhib#not &NULL}a {herg_inhib__names__noun}.""",
