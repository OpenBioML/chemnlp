...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {activity_choline_transporter#not &NULL}{activity_choline_transporter__names__gerund}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {activity_choline_transporter__names__gerund}:<EOI>{activity_choline_transporter#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_choline_transporter__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{activity_choline_transporter#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_choline_transporter__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {activity_choline_transporter#not &NULL}{activity_choline_transporter__names__gerund}.""",
