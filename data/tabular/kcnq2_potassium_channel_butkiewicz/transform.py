...
journal = {Chemical Science}}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} {#represents|is from!} a molecule that {#shows|exhibits|displays!} {activity_kcnq2_potassium_channel#no &NULL}{activity_kcnq2_potassium_channel__names__noun}.",  # noqa: E501
