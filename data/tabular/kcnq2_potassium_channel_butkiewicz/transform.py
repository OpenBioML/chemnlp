...
journal = {Chemical Science}}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} represents a molecule that {#shows|exhibits|displays!} {activity_kcnq2_potassium_channel#no &NULL}{activity_kcnq2_potassium_channel__names__noun}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {activity_kcnq2_potassium_channel#not &NULL}{activity_kcnq2_potassium_channel__names__gerund}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {activity_kcnq2_potassium_channel__names__gerund}:<EOI>{activity_kcnq2_potassium_channel#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_kcnq2_potassium_channel__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{activity_kcnq2_potassium_channel#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_kcnq2_potassium_channel__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {activity_kcnq2_potassium_channel#not &NULL}{activity_kcnq2_potassium_channel__names__gerund}.""",
