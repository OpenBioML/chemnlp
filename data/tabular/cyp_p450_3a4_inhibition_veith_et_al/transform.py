...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {CYP3A4_inhibition#not &NULL}{CYP3A4_inhibition__names__gerund}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {CYP3A4_inhibition__names__gerund}:<EOI>{CYP3A4_inhibition#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {CYP3A4_inhibition__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{CYP3A4_inhibition#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {CYP3A4_inhibition__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {CYP3A4_inhibition#not &NULL}{CYP3A4_inhibition__names__gerund}.""",
