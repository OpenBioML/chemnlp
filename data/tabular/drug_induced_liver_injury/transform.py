...
journal = {Journal of Chemical Information and Modeling}""",
        ...
        "templates": [
            ...
            "The {SMILES__description} {SMILES#} represents a molecule that is {liver_injury#not &NULL}identified as causing a {liver_injury__names__noun}.",
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {liver_injury#not &NULL}causing a {liver_injury__names__noun}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} causing a {liver_injury__names__noun}:<EOI>{liver_injury#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that {#shows|causes!} a {liver_injury__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{liver_injury#False&True}""",
