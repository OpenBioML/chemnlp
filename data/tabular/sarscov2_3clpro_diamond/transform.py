...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {activity_SARSCoV2_3CLPro#not &NULL}{activity_SARSCoV2_3CLPro__names__gerund}: {SMILES#}""",
            ...
            "Is the {SMILES__description} {SMILES#} {activity_SARSCoV2_3CLPro__names__gerund}:<EOI>{activity_SARSCoV2_3CLPro#no&yes}",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_SARSCoV2_3CLPro__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{activity_SARSCoV2_3CLPro#False&True}""",
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_SARSCoV2_3CLPro__names__gerund}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result:<EOI>This molecule is {activity_SARSCoV2_3CLPro#not &NULL}{activity_SARSCoV2_3CLPro__names__gerund}.""",
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {activity_SARSCoV2_3CLPro__names__gerund}.
Result:<EOI>{SMILES#}""",
