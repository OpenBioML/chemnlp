        ...
        "targets": [
            {
                ...
                "type": "boolean",
                "names": [
                    {"gerund": "blocking potassium ion channel activity"},
                    {"noun": "blocker of potassium ion channel activity"},
                    {
                        "adjective": "effective for blocking potassium ion channel activity"
                    },
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {activity_potassium_ion_channel#not &NULL}{activity_potassium_ion_channel__names__adjective}: {SMILES#}""",  # noqa: E501
            ...
            "Is the {SMILES__description} {SMILES#} {activity_potassium_ion_channel__names__adjective}:<EOI> {activity_potassium_ion_channel#yes&no}",  # noqa: E501 for the benchmarking setup <EOI> separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {activity_potassium_ion_channel__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
