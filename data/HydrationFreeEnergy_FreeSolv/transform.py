...
def get_and_transform_data():
    # get raw data
    target_folder = 'HydrationFreeEnergy_FreeSolv'
    ...
    fields_clean = ['compound_name', 'SMILES', 'hydration_free_energy']
    ...
    meta =  {
        ...
        "description": """The Free Solvation Database, FreeSolv(SAMPL), provides experimental and calculated hydration free energy of small molecules in water. The calculated values are derived from alchemical free energy calculations using molecular dynamics simulations. From MoleculeNet.""",
        "targets": [
            {
