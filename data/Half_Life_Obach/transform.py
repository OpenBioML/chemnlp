...
def get_and_transform_data():
    ...
    meta = {
        ...
        "description": """Half life of a drug is the duration for the concentration of the drug in the body to be reduced by half. It measures the duration of actions of a drug. This dataset deposited version under CHEMBL assay 1614674.""",
        "targets": [
            {
                "id": "half_life_duration",  # name of the column in a tabular dataset
                "description": "The half-life (t1/2) is the time it takes for the plasma concentration of a drug or the amount of drug in the body to be reduced by 50%",  # description of what this column means
