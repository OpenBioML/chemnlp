...
DATASET_URL = "https://huggingface.co/datasets/adamoyoung/mona/resolve/main/data/mona_df.json"
...
META_TEMPLATE = {
    ...
    "targets": [
        ...
        },
        {
            ...
            "description": "The normalized entropy of the spectrum (ratio of spectral entropy to maximum possible entropy for a spectrum with the same number of peaks)"
        }
    ],
    "identifiers": [
        {
    ...
    "fields": {
        "exp_values": [
            ...
            },
            {
                ...
                "text": "The normalized entropy of the spectrum (ratio of spectral entropy to maximum possible entropy for a spectrum with the same number of peaks)"
            },
        ],
        "metadata": [
            {
