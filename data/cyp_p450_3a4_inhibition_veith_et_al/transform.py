...
def get_and_transform_data():
    # get raw data
    target_folder = 'CYP_P450_3A4_Inhibition_Veith_et_al'
        ...
        "targets": [
            {
                ...
                "description": "The ability of the drug to inhibit CYP P450 3A4 (1) or not (0)",  # description of what this column means
