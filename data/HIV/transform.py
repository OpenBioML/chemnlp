...
#     )  # remove leading and trailing white space characters
    ...
    meta =  {
        ...
        "description": """The HIV dataset was introduced by the Drug Therapeutics Program (DTP) AIDS Antiviral Screen, which tested the ability to inhibit HIV replication for over 40,000 compounds. From MoleculeNet..""",
        "targets": [
            {
                "id": "activity_HIV",  # name of the column in a tabular dataset
                "description": "whether it active against HIV virus (1) or not (0).",  # description of what this column means
