...
def get_and_transform_data():
    # get raw data
    target_folder = 'CYP2C9_Substrate_CarbonMangels'
...
#     # data cleaning
    ...
    meta = {
        ...
        "description": """CYP P450 2C9 plays a major role in the oxidation of both xenobiotic and endogenous compounds. Substrates are drugs that are metabolized by the enzyme. TDC used a dataset from Carbon Mangels et al, which merged information on substrates and nonsubstrates from six publications.""",
        "targets": [
            {
                "id": f"{'_'.join(target_subfolder.split('_')[:2])}",  # name of the column in a tabular dataset
                "description": "The drugs that are metabolized by the CYP P450 2C9 (1) or not (0)",  # description of what this column means
        ...
        "bibtex": [
          ...
          title = {Selecting Relevant Descriptors for Classification by Bayesian Estimates: A Comparison with Decision Trees and Support Vector Machines Approaches for Disparate Data Sets},
