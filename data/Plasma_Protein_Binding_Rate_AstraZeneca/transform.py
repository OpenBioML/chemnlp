...
def get_and_transform_data():
    ...
    meta = {
        ...
        "description": """The human plasma protein binding rate (PPBR) is expressed as the percentage of a drug bound to plasma proteins in the blood. This rate strongly affect a drug's efficiency of delivery. The less bound a drug is, the more efficiently it can traverse and diffuse to the site of actions. From a ChEMBL assay deposited by AstraZeneca.""",
        "targets": [
            {
        ...
        "identifiers": [
            ...
            },
            {
                ...
                "description": "Species which drug have a percentage bound to plasma proteins in blood",  # description (optional, except for "Other")
            },
            {
