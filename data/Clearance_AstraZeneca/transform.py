...
def get_and_transform_data():
    ...
    meta = {
      ...
      publisher = {{EMBL}-{EBI}},
      author = {Anne Hersey},
      title = {{ChEMBL} Deposited Data Set - {AZ}{\_}dataset}}""",
          ...
          volume = {57},
          pages = {441--448},
          author = {Li Di and Christopher Keefer and Dennis O. Scott and Timothy J. Strelevitz and George Chang and Yi-An Bi and Yurong Lai and Jonathon Duckworth and Katherine Fenner and Matthew D. Troutman and R. Scott Obach},
          title = {Mechanistic insights from comparing intrinsic clearance values between human liver microsomes and hepatocytes to guide drug design},
