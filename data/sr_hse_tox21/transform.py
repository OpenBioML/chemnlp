        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    f"{target_subfolder}",
                    "Tox21",
                    "Tox21 SR-Heat shock response",
                    "SR-Heat shock response",
                    "Heat shock response assay",
                    "Heat shock response toxicity",

                ],
            },
        ],
        "uris":[
                "https://bioportal.bioontology.org/ontologies/MESH?p=classes&conceptid=http%3A%2F%2Fpurl.bioontology.org%2Fontology%2FMESH%2FD018869",
