        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    f"{target_subfolder}",
                    "Tox21",
                    "Tox21 SR-p53 response",
                    "SR-p53 response",
                    "p53 response assay",
                    "p53 response toxicity",
                    "Tox21 p53",
                ],
            },
        ],
        "uris": [
            "https://bioportal.bioontology.org/ontologies/CCO?p=classes&conceptid=http%3A%2F%2Fpurl.obolibrary.org%2Fobo%2FNCBIGene_2768677",
            "https://bioportal.bioontology.org/ontologies/HINO?p=classes&conceptid=http%3A%2F%2Fpurl.obolibrary.org%2Fobo%2FHINO_0017892",
