        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    {"verb": f"activitiy in the {target_subfolder} toxicity assay"},
                    {"verb": "activitiy in the SR-p53 response toxicity assay"},
                    {"verb": "activitiy in the p53 response toxicity assay"},
