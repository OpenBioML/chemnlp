#! /bin/bash
#SBATCH --job-name="llched-tokenise"
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=12
#SBATCH --output=/fsx/proj-chemnlp/experiments/logs/tokenise_%j.out
#SBATCH --error=/fsx/proj-chemnlp/experiments/logs/tokenise_%j.err
...
### The third arg ($3) is the full path to the tokenisation configuration file
